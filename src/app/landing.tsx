...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(17,94,89,0.18),transparent_34%),radial-gradient(circle_at_top_right,rgba(245,158,11,0.18),transparent_28%),linear-gradient(180deg,#f8f5ef_0%,#fffdf8_46%,#f5efe6_100%)] font-sans text-slate-900">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-6 sm:px-10 lg:px-12">
        <div className="relative border-b border-slate-200 pb-5">
          <div className="flex items-center justify-between">
            <div className="min-w-0">
              <div className="font-display text-sm font-bold uppercase tracking-[0.32em] text-teal-700 sm:text-base">
                LeadFlow
              </div>
        ...
        <div className="grid flex-1 gap-10 py-10 sm:py-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-12">
          <div className="max-w-2xl">
            ...
            <div className="font-display mt-6 text-3xl font-semibold leading-[1.08] tracking-tight text-slate-900 sm:mt-8 sm:text-5xl lg:text-6xl">
              Transforme o WhatsApp em um funil simples de vendas imobiliárias.
            </div>
            <div className="font-body mt-5 max-w-xl text-base leading-7 text-slate-500 sm:mt-6 sm:text-lg sm:leading-8 lg:text-xl">
            ...
            <div className="mt-10 grid grid-cols-3 gap-2 sm:mt-12 sm:gap-4">
              <div className="rounded-2xl border border-slate-200 bg-white/90 px-3 py-3 shadow-sm backdrop-blur sm:rounded-3xl sm:px-6 sm:py-5">
                <div className="text-[10px] text-slate-400 sm:text-sm">
                  Resposta inicial
                </div>
                <div className="font-display mt-1.5 text-base font-semibold text-slate-900 sm:mt-3 sm:text-3xl">
                  instantânea
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white/90 px-3 py-3 shadow-sm backdrop-blur sm:rounded-3xl sm:px-6 sm:py-5">
          ...
          >
            <div className="grid gap-3 sm:gap-4 lg:grid-cols-[0.92fr_1.08fr]">
              <div className="rounded-xl bg-white/6 p-3 sm:rounded-3xl sm:p-4">
                <div className="text-[10px] uppercase tracking-[0.24em] text-slate-400 sm:text-xs">
                  Leads ativos
                </div>
                <div className="mt-2 flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="shrink-0 whitespace-nowrap rounded-full bg-emerald-500/18 px-2 py-0.5 text-[10px] font-medium text-emerald-300 sm:px-3 sm:py-1 sm:text-xs">
                    5 quentes
                  </div>
                </div>
                  ...
                  {priorityLeads.map((lead) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div className="shrink-0 whitespace-nowrap rounded-full bg-amber-500/15 px-2 py-0.5 text-[10px] font-semibold text-amber-300 sm:px-3 sm:py-1 sm:text-xs">
                          {lead.score}
                        </div>
                      </div>
                      ...
                      <div className="mt-2 text-xs leading-5 text-slate-400 sm:mt-3 sm:text-sm sm:leading-6">
                        {lead.detail}
                      </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="rounded-xl bg-white p-4 text-slate-900 sm:rounded-3xl sm:p-5">
                  <div className="flex items-center gap-2">
                    <div className="text-[10px] uppercase tracking-[0.24em] text-slate-500 sm:text-xs">
                      Conversa assistida
                    </div>
                    <div className="shrink-0 whitespace-nowrap rounded-full bg-teal-700 px-2 py-0.5 text-[10px] font-semibold text-white sm:px-3 sm:py-1 sm:text-xs">
                      Lead quente
                    </div>
                  </div>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            <div className="font-display text-xs font-semibold uppercase tracking-[0.28em] text-amber-600 sm:text-sm">
              Como funciona
            </div>
            <div className="font-display mt-4 text-2xl font-semibold tracking-tight text-slate-900 sm:mt-5 sm:text-4xl">
              Um fluxo direto para responder, qualificar e entregar contexto.
            </div>
            <div className="font-body mt-4 text-base leading-7 text-slate-500 sm:mt-5 sm:text-lg sm:leading-8">
          ...
          <div className="mt-8 grid gap-4 sm:mt-12 sm:gap-5 lg:grid-cols-3">
            {qualificationSteps.map((step, index) => (
              ...
              >
                ...
                <div className="font-display mt-5 text-xl font-semibold text-slate-900 sm:mt-6 sm:text-2xl">
                  {step.title}
                </div>
                <div className="font-body mt-3 text-sm leading-6 text-slate-500 sm:mt-4 sm:text-base sm:leading-7">
                  {step.description}
                </div>
              </div>
            ))}
      ...
      <div className="px-4 py-14 sm:px-10 sm:py-20 lg:px-12">
        <div className="mx-auto grid max-w-7xl gap-6 sm:gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-2xl border border-slate-200 bg-slate-900 p-6 text-white shadow-[0_24px_70px_rgba(41,37,36,0.18)] sm:rounded-[2rem] sm:p-8">
            <div className="font-display text-xs font-semibold uppercase tracking-[0.28em] text-emerald-400 sm:text-sm">
            ...
            <div className="font-body mt-4 text-base leading-7 text-slate-400 sm:mt-5 sm:text-lg sm:leading-8">
          ...
          <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
            {systemHighlights.map((item) => (
              ...
              >
                ...
                <div className="font-body mt-4 text-sm leading-6 text-slate-500 sm:mt-5 sm:text-lg sm:leading-7">
                  {item}
                </div>
              </div>
            ))}
      ...
      <div className="border-t border-slate-200 px-4 py-6 sm:px-10 sm:py-8 lg:px-12">
